;$(function(){
	...
	var addSubMenuBtn = '<li class="custom-menu-view__menu__sub__add"><div class="text-ellipsis"><i class="glyphicon glyphicon-plus text-info"></i></div></li>';
	var addMenuBtn = '<div class="custom-menu-view__menu"><div class="text-ellipsis"><i class="glyphicon glyphicon-plus text-info iBtn"></i></div></div>';
	...
	var customUl='<ul class="custom-menu-view__menu__sub">' + addSubMenuBtn + '</ul>';
	var customLi='<li class="custom-menu-view__menu__sub__add"><div class="text-ellipsis">新建子菜单</div></li>';

	var eventCreateMenuBtn = function() {
	...
	function sortableMenu(sortIndex) {
		if(sortIndex){
	...
	function sortableSubMenu(m,sortIndex){
		if(sortIndex){
	...
	$('#delMenu').click(function(){
		...
		if(is_Actived){
			...
			if(button.length === 3){
				$('.subbutton__actived').parent().append(addMenuBtn);
				eventCreateMenuBtn();
			}
			...
			if(button[rowIndex].sub_button.length === 5){
				$('.subbutton__actived').parent().append(addSubMenuBtn);
			}
			$('.subbutton__actived').remove();
